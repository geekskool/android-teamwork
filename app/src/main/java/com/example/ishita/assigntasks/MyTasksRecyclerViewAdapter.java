...
import com.example.ishita.assigntasks.TasksFragment.OnListFragmentInteractionListener;
import com.example.ishita.assigntasks.TasksFragment.DummyItem;
...
public class MyTasksRecyclerViewAdapter extends RecyclerView.Adapter<MyTasksRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        String content = mValues.get(position).taskName + "\n" +
                mValues.get(position).assigneeContact;
